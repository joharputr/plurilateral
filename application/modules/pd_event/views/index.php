...
<body id="top">
    ...
    <header id="home">
        ...
        style="background: url('<?php echo base_url()?>assets/image/event/conference.jpg') no-repeat center center fixed;">
            ...
            <div class="row startchange">
                <div class="col-lg-12 mx-auto inner">
                    <h1 class="tulisan text-center mx-auto"><a href="" class="typewrite" data-period="2000"
                        data-type='[ "Plurilateral dialogue", "Plurilateral dialogue", "Plurilateral dialogue", "Plurilateral dialogue" ]'><span
                    ...
                    <div class="row">
                        <div class="col-md-12 wp1 mt-4">
                            <figure class="figure">
                               ...
                               <a href="<?php echo base_url()?>event/about"> <figcaption class="figure-caption" >ABOUT EVENT</figcaption> </a>
                            </figure>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 wp1 mt-4">
                            <figure class="figure">
                                ...
                                class="figure-img img-fluid rounded"
                                alt="A generic square placeholder image with rounded corners in a figure.">
                                <a href="<?php echo base_url()?>event/goal"> <figcaption class="figure-caption">GOALS</figcaption></a>
                            </figure>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 wp1 mt-4">
                            <figure class="figure">
                                ...
                                class="figure-img img-fluid rounded"
                                alt="A generic square placeholder image with rounded corners in a figure.">
                                <a href="<?php echo base_url()?>event/readm"><figcaption class="figure-caption">ADMINSTRATIVE ARRANGEMENT</figcaption></a>
                            </figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <table class="table table-sm table-hover table-bordered">
                        <thead class="schedule-head">
                            <tr>
                                <th style="vertical-align: middle; width: 20%">Date</th>
                                <th style="vertical-align: middle; width: 20%">Time</th>
                                <th style="vertical-align: middle; width: 60%">Program</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <ul>
                                     <li> High Level Panel 1:</li>
                                     <span>Role of States in Promoting Healthy Practices of Freedom of Expression while protecting Freedom of Religion and Belief </span>
                                     <li>Regional Perspectives from:</li> 
                                     ...
                                     <span>-   Tunisia</span> 
                                     <li>Moderator: Vice Minister MoFA </li>
                                 </ul>
                             </td>
                         </tr>
                         <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <li>High Level Panel 2</li>
                                    <span>Update on International initiatives in Combating intolerance, negative stereotyping and stigmatization of, and discrimination, incitement to violence, and violence against persons based on religion or belief</span>
                                    <li>Speakers:</li>
                                    <span>- Prof. Dr. Abdul Rahman Mas’ud, Head of Research and Development Agency</span><br>
                                    <span>-   Mr. Yuri Boychenko, Anti Discrimination Unit, Office of the UN High Commissioner of Human Rights </span><br>
                                    <span>Optional:  President of UN Human Rights Council </span><br>
                                    <span>-   Dr. Kaggwa, Chair IPHRC OIC </span><br>
                                    <span>-   European Union – Special Envoy for the Promotion of Freedom of Religion of Belief</span><br>
                                    <span>-   tbc</span><br>
                                    <li>Moderator: H.E. Hasan Kleib, Permanent Representative of Indonesia in Jenewa </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <h4>COFFEE BREAK/INTERSESSIONAL </h4>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <li>Expert Panel 3</li>
                                    <span>Multi stakeholders Collaboration to Promote Tolerance and Healthy Practices of Freedom of Expression</span>
                                    <li>Speakers:</li>
                                    <span>-   Tarok Grabor from EU</span><br>
                                    <span>-   Prof. Evelyn Aswad, Academician from the US </span><br>
                                    <span>-   Forum Asia </span><br>
                                    <span>-   Article 19 </span><br>
                                    <span>-   Sidney Jones</span><br>
                                    <span>-   Ida Pangelingsir Agung Putra Sukahet, Head of the AssociationForum of Inter-Teligious Harmony </span><br>
                                    <li>Moderator:  H.E. Hassan Wirajuda </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <h4>Reception hosted by Minister/Vice Minister of Foreign Affairs and Minister for Religious Affairs of Indonesia </h4>
                                </ul>
                            </td>
                        </tr>
<!-- day2 -->
                            <tr>
                                <td rowspan="7">Day Two</td>
                                <td>09.00 -11.00</td>
                                <td class="text-left">
                                    <ul>
                                     <li> Expert Panel 4</li>
                                     <span>The Role of Media  </span>
                                     <li>Speakers:</li> 
                                     <span>-   Facebook</span><br>
                                     <span>-   Fox</span><br>
                                     <span>-   Channel News Asia</span><br>
                                     <span>-   Google</span><br>
                                     <span>-   Kompas</span><br>
                                     <span>-   Al Jazeera</span> 
                                     <li>Moderator: Najwa Shihab / Desi Anwar/Fifi Aledya Yahya </li>
                                 </ul>
                             </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-left">
                                    <ul>
                                     <li> Expert Panel 5</li>
                                     <span>International Partnership to promote Tolerance and Healthy Practices Freedom of Expression</span>
                                     <li>Speakers:</li> 
                                     <span>-   Asia Foundation</span><br>
                                     <span>-   Ford Foundation</span><br>
                                     <span>-   King Abdullah bin Abdul Azis International Center for Interreligious and Intercultural Dialogue (KAICIID) / King Hussein Foundation</span><br>
                                     <span>-   Norwegian Centre for Human Rights</span><br>
                                     <span>-   Indonesia AID (TBC)</span><br>
                                     <span>-   UNDP/Convey</span> 
                                     <li>Moderator: Yenny Wahid, Wahid Foundation </li>
                                 </ul>
                             </td>
                         </tr>
                         <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <li>Panel 6</li>
                                    <span>Discussion on Instilling Culture of Tolerance in Youth</span>
                                    <li>Speakers:</li>
                                    <span>-   Asia Catholic Youth</span><br>
                                    <span>-   European Youth </span><br>
                                    <span>-   African Youth </span><br>
                                    <span>-   FEALAC Youth Center </span><br>
                                    <span>-   Dewa Bujana – Indonesia (Well Known Musician and Activist)</span><br>
                                    <span>-   Millennial Islami</span><br>
                                    <li>Moderator: Irfan Amalee (PeaceGen) </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <h4>Testimony Best Practices on Promoting Tolerance (tbc)</h4>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    ...
                                    <li>Closing Remarks  by Minister of Religious Affairs</li>
                                    <span>Adoption Jakarta Goals for Tolerance/Chair Statement</span><br>
<span>Chair: Director Generale of Multilateral Cooperation/Director General for Information and Public Diplomacy </span>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <ul>
                                    <h4>Reception hosted by Minister for Religious Affairs of Indonesia </h4>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                                <td>Day Three</td>
                                <td>09.00 - 12.00</td>
                                <td class="text-left">Site Visit to Istiqlal Mosque – Cathedral</td>
                            </tr>
                    </tbody>
                </table>
