...
<div class="container" style="margin-top: 130px; ">
            ...
            <div class="row">
                <div class="col-md-12 text-center" style="margin-bottom: 50px;">
                    <div class="page-title">
                        <h2 style="color: #1E90FF">SPECIAL FEATURES</h2>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 ">
                    <div class="box">
                        <div class="box-icon card-img-wrap" style="text-align: center;">
                            <img src="./assets/images/logo_event.png" alt="" style="height: 130px; width: 130px;">
                        </div>
    ...
    <!-- RESOURCES -->
    <section class="gray-bg section-padding" id="feature-page" style="margin-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center" style="margin-bottom: 50px;">
                    <div class="page-title">
				...
				<div class="col-xl-6 calendar_col">
					<div class="calendar_container">
						<div class="calendar_title_bar d-flex flex-row align-items-center justify-content-start">
							...
							<div class="calendar_title">UPCOMMING EVENT</div>
						</div>
						<div class="calendar_items">
							
							<!-- Calendar Item -->
							<div class="calendar_item d-flex flex-row align-items-center justify-content-start">
								<div><div class="calendar_item_image"><img src="./assets/images/logo_event.png" alt=""></div></div>
