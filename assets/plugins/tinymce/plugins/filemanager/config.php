...
$root = rtrim($_SERVER['DOCUMENT_ROOT'], '/') . "/erp-mpb/"; // don't touch this configuration
//**********************
//Path configuration
//**********************
...
$base_url = "http://localhost/erp-mpb/"; //url base of site if you want only relative url leave empty
$upload_dir = 'assets/filemanager'; // path from base_url to upload base dir
$current_path = '../../../assets/thumbs'; // relative path from filemanager folder to upload files folder
